        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="about talent" src="./themes/Yaru/status/about.svg" />
    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Talent Service</span> ,</div>
    ...
    return (
        <>
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list">
                ...
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div> My areas of expertise are <strong className="text-ubt-gedit-orange">Fullstack Development, React.js & MERN Stack javascript!</strong></div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
...
function Projects() {
    const project_list = [
        {
            name: "Car Rent",
            date: "Mar 2023",
            link: "https://github.com/talentservice129/car-rent",
            description: [
                "Typescript & SCSS & CSS & Javascript",
            ],
            domains: ["javascript", "next.js", "CSS"]
        },
        {
            name: "Doceo Admin",
            date: "Mar 2023",
            link: "https://github.com/talentservice129/doceo-admin",
            description: [
                "Doceo Admin Panel",
            ],
            domains: ["typescript"]
        },
        {
            name: "portfolio",
            date: "Mar 2023",
            link: "https://github.com/talentservice129/portfolio",
            description: [
                "portfolio",
            ]
        },
        {
            ...
            date: "Feb 2023",
            link: "https://github.com/talentservice129/MERN-Starter-Template",
            description: [
                "Starter Kit Of Merns Stack",
            ]
        },
        {
            name: "Noala Api",
            date: "Feb 2023",
            link: "https://github.com/talentservice129/noala-api",
            description: [
                "Noala Api",
            ],
            domains: ["typescript"]
        },
        {
            name: "Noala Frontend",
            date: "Feb 2023",
            link: "https://github.com/talentservice129/noala-frontend",
            description: [
                "Noala Frontend",
            ],
            domains: ["HTML"]
        ...
        {
            name: "Vue.js 3 Simple Test Page",
            date: "Jan 2023",
            link: "https://github.com/talentservice129/-Vue.js-3-Simple-Test-Page",
            description: [
                "Simple test page with Vue.js 3",
            ],
            domains: ["Vue"]
        },
        {
            name: "Next Amplify",
            date: "Nov 2020",
            link: "https://github.com/talentservice129/next-amplify",
            description: [
                "Next, Amplify",
            ],
            domains: ["CSS"]
        },
        {
            name: "Chatgpt Server",
            date: "Jan 2023",
            link: "https://github.com/talentservice129/chatgpt-server",
            description: [
                "The server of chatgpt.",
            ],
            domains: ["Javascript"]
        },
        {
            name: "Chatgpt Client",
            date: "Jan 2023",
            link: "https://github.com/talentservice129/chatgpt-client",
            description: [
                "Client side of Chatgpt.",
            ],
            domains: ["Javascript"]
        }
    ];
    ...
    return (
        <>
            ...
            <iframe src="https://github.com/sponsors/talentservice129/card" title="Sponsor talentservice129" className='my-4 w-5/6 md:w-3/4' ></iframe>
                            ...
                            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                                <div className="flex flex-wrap justify-between items-center">
                                    <div className='flex justify-center items-center'>
                                        ...
                                        <iframe src={`https://ghbtns.com/github-btn.html?user=talentservice129&repo=${projectName}&type=star&count=true`} frameBorder="0" scrolling="0" width="150" height="20" title={project.name.toLowerCase()+"-star"}></iframe>
                                    </div>
